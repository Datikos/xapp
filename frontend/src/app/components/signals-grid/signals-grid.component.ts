    ...
    <div class="layout-grid layout-grid--signals">
      <section class="card signals card-list">
        ...
        <div class="card-body">
          ...
          @if (signals.length) {
            <ul>
              @for (signal of signals.slice(-30); track signal) {
                <li>
      ...
      <section class="card fast-signals card-list">
        ...
        <div class="card-body">
          ...
          @if (fastSignals.length) {
            <ul>
              @for (signal of fastSignals.slice(-30); track signal) {
                <li>
                  <div class="signal-meta">
                    <span class="pill" [class.long-pill]="signal.type === 'LONG'" [class.short-pill]="signal.type === 'SHORT'">{{ signal.type }}</span>
                    <span class="price">@ {{ signal.price | number: '1.0-0' }}</span>
      ...
      @if (hasValidations) {
        <section class="card validations card-list">
          <header class="card-heading">
          ...
          <div class="card-body">
            <ul>
              @for (validation of validations.slice(-15); track validation) {
                <li>
                  <div class="signal-meta">
                  ...
                  <p class="signal-reason">
                    ...
                    @if (validation.directionChangePct !== null) {
                      <span>
      ...
      @if (nearMisses.length) {
        <section class="card diagnostics card-list">
          <header class="card-heading">
          ...
          <div class="card-body">
            <ul>
              @for (miss of nearMisses.slice(-10); track miss) {
                <li>
                  <div class="signal-meta">
